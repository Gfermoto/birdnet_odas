...
![Устройство BirdNET-ODAS](images/photo_2.jpg)
...
![ReSpeaker USB 4 Mic Array](images/photo_4.jpg)
...
![Защита микрофона](images/photo_6.jpg)
...
![Система в полевых условиях](images/photo_8.jpg)
*Рис. 4: Установка системы в поле для длительных испытаний*
...
![Спектрограмма - обычный микрофон](images/s1.jpg)
*Рис. 5: Спектрограмма записи с обычного микрофона - виден значительный фоновый шум*
...
![Спектрограмма - ODAS + фильтрация](images/s2.jpg)
*Рис. 6: Спектрограмма после обработки - чистый сигнал без шума*
...
![Веб-интерфейс BirdNET-Go](images/photo_7.jpg)
*Рис. 7: Dashboard BirdNET-Go с результатами распознавания*
...
- **Создание открытой платформы** — проект опубликован на GitHub ([https://github.com/Gfermoto/birdnet_odas](https://github.com/Gfermoto/birdnet_odas)) с полной документацией (4500+ строк) и доступен для использования и модификации под лицензией MIT
...
**Рабочая станция:** [https://birdnet.eyera.info](https://birdnet.eyera.info)

**Станция на карте BirdWeather:** [https://app.birdweather.com/stations/18409/](https://app.birdweather.com/stations/18409/)

*Последнее обновление: Март 2026 (версия 1.0.0)*

---

**Теги:** #обработка_сигналов #машинное_обучение #raspberry_pi #python #алгоритмы #dsp #шумоподавление #распознавание_речи #opensource

**Хабы:** Разработка под Linux, Машинное обучение, Python, Обработка звука, Open source, Robotics
