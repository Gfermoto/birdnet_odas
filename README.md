...
В галерее представлены сравнения спектрограмм, демонстрирующие улучшение качества записи при использовании ODAS и фильтрации по сравнению с обычным микрофоном.
