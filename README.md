...
В галерее представлены сравнения спектрограмм, демонстрирующие значительное улучшение качества записи при использовании ODAS и продвинутой фильтрации по сравнению с обычным микрофоном.
