...
- **Стационарное шумоподавление** — подавление постоянных фоновых шумов (параметр `GAMMA_NS_SR = 2.5` для усиленного подавления)
...
Параметры `MIN_NS_SR = 0.1` и `MIN_NN_SR = 0.1` обеспечивают глубокое подавление шума (меньшее значение означает большее подавление).
