...
- `AGCMAXGAIN`: default 30dB → **8.0 dB** - консервативное усиление для улучшения чувствительности без усиления шума (диапазон: 0-60 dB)
...
1. **AGCMAXGAIN = 8.0 dB**: Консервативное усиление, достаточное для улучшения чувствительности к тихим звукам, но не настолько высокое, чтобы усиливать фоновый шум. После установки ветрозащиты можно увеличить до 10-12 dB.
