...
| `ALPHA` | 0.85 | Мягкое подавление: снижение шума ~2x без артефактов и эффекта "то тишина, то прорывается" |
| `NOISE_FRAMES` | 12 | Баланс между оценкой шума и адаптивностью к изменениям |
