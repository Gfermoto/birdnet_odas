...
| `MIN_GAIN` | 0.01 | Spectral floor (-40 dB): минимальное значение gain. Агрессивное подавление фонового шума при минимальных артефактах. 0.1 оставляет слишком много шума! |
| `NOISE_ESTIMATE_ADAPT_ALPHA` | 0.995 | Скорость адаптации шумовой модели (0.995 = медленное обновление, ~10 сек). Медленная адаптация защищает от включения птиц и фоновых звуков в модель шума |
