...
- ✅ **Текущие настройки оптимизированы:**
  - `ALPHA = 0.50` - минимальное сглаживание, подавление ~30-40% без артефактов
...
**Решение:**
- Текущие настройки (`ALPHA = 0.50`, `NOISE_FRAMES = 10`) обеспечивают снижение шума ~30-40%
...
- ✅ **Текущие настройки уже оптимизированы для сохранения слабых сигналов:**
  - `ALPHA = 0.50` - минимальное сглаживание, максимальное сохранение сигналов
  - `NOISE_FRAMES = 10` - быстрая адаптация к появлению птиц
...
2. **Улучшение подавления шума:**
   ...
   - ✅ `ALPHA = 0.50` - минимальное сглаживание, подавление ~30-40% (оптимально для записи птиц)
   - Если нужно большее подавление, можно увеличить `ALPHA` до 0.75-0.85

3. **Сохранение слабых сигналов:**
   - ✅ Текущие настройки (`ALPHA = 0.50`) уже оптимизированы для максимального сохранения сигналов
   - Если нужно еще большее сохранение, можно уменьшить `ALPHA` до 0.40-0.45
