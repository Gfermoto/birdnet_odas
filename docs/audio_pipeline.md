...
| `ALPHA` | 0.98 | Оптимизировано для подавления стационарного шума (ЛЭП, вентиляторы) |
| `NOISE_FRAMES` | 15 | Увеличено для лучшей оценки шума и подавления фоновых звуков |
...
**Решение:**
- Увеличить `NOISE_FRAMES` в `log_mmse_processor.py` (по умолчанию 10) для лучшей оценки шума
...
- При необходимости увеличьте `ALPHA` до 0.98 для лучшего подавления стационарного шума
...
- **ALPHA = 0.98** - оптимизировано для максимального подавления стационарного шума (ЛЭП, вентиляторы)
- **NOISE_FRAMES = 15** - увеличено для лучшей оценки шума и подавления фоновых звуков
...
2. **Улучшение подавления шума:**
   - ✅ `NOISE_FRAMES = 15` - уже применено для лучшей оценки шума
   - ✅ `ALPHA = 0.98` - уже применено для максимального подавления стационарного шума (ЛЭП)
