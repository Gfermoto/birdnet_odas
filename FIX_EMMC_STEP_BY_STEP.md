...
3. Найди и удали ВСЕ эти строки:
...
4. Сохрани файл
5. **ВАЖНО:** Убедись, что файл сохранен правильно (проверь, что изменения применились)

## Шаг 3: Удалить проблемный сервис
