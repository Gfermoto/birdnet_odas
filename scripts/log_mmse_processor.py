...
ALPHA = 0.88         # Decision-Directed smoothing (баланс подавления и естественности)
...
ALPHA = 0.88       # Decision-Directed smoothing factor
                   # 0.88 обеспечивает баланс: эффективное подавление нестационарного шума (ветер)
                   # при сохранении естественности звука и быстрой адаптации к изменениям
                   # Диапазон: 0.85-0.95 для нестационарного шума, 0.95-0.98 для стационарного
